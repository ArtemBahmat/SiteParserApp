    ...
    public class UrlHelper
    {
        public static string GetCorrectUrl(string url)
        {
            ...
            if (!string.IsNullOrEmpty(url))
            {
                ...
                if ((url.StartsWith(http) || url.StartsWith(https)) && url.EndsWith(slesh))
                    return url;
                else
                {
                    if (!(url.StartsWith(http) || url.StartsWith(https)) && !url.EndsWith(slesh))
                    {
                        result = string.Concat(http, url, slesh);
                    }
                    else
                    {
                        if (!url.StartsWith(http))
                        {
                            result = string.Concat(http, url);
                        }
                        if (!url.EndsWith(slesh))
                        {
                            result = string.Concat(url, slesh);
                        }
                    }
                }
            }
        ...
        public static string GetAbsoluteUrl(string href, string baseUrl)
        {
